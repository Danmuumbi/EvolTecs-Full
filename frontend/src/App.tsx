...
import { AdminLayout } from './components/layout/AdminLayout'; // ← Fixed: uppercase A
...
// Admin Routes - Fixed imports with correct casing
import { AdminDashboard } from './routes/admin/AdminDashboard'; // ← Fixed: uppercase A
  ...
  return (
    <Routes>
      ...
      <Route element={<ClientLayout />}>
        <Route 
          path="/dashboard" 
          element={user?.role === 'customer' || user?.role === 'admin' ? <Dashboard /> : <Navigate to="/login" />} 
        />
        <Route 
          path="/my-domains" 
          element={user ? <MyDomains /> : <Navigate to="/login" />} 
        />
        <Route 
          path="/my-hosting" 
          element={user ? <MyHosting /> : <Navigate to="/login" />} 
        />
        <Route 
          path="/my-emails" 
          element={user ? <MyEmails /> : <Navigate to="/login" />} 
        />
        <Route 
          path="/invoices" 
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route 
          path="/admin/users" 
          element={user?.role === 'admin' ? <ManageUsers /> : <Navigate to="/" />} 
        />
        <Route 
          path="/admin/domains" 
          element={user?.role === 'admin' ? <ManageDomains /> : <Navigate to="/" />} 
        />
        <Route 
          path="/admin/hosting" 
          element={user?.role === 'admin' ? <ManageHosting /> : <Navigate to="/" />} 
        />
        <Route 
          path="/admin/payments" 
          element={user?.role === 'admin' ? <ManagePayments /> : <Navigate to="/" />} 
        />
        <Route 
          path="/admin/support" 
          element={user?.role === 'admin' ? <ManageSupport /> : <Navigate to="/" />} 
        />
      </Route>
